...
/**
 * Test case for class \ZECHENDORF\Bazaar\Domain\Model\Shipment.
 *
 ...
 */
class ShipmentTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \ZECHENDORF\Bazaar\Domain\Model\Shipment
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \ZECHENDORF\Bazaar\Domain\Model\Shipment();
	}
	 ...
	 * @test
	 */
	public function getShippingIdReturnsInitialValueForString()
	{
		$this->assertSame(
			'',
			$this->subject->getShippingId()
		);
	}
	 ...
	 * @test
	 */
	public function setShippingIdForStringSetsShippingId()
	{
		$this->subject->setShippingId('Conceived at T3CON10');
	 ...
	 * @test
	 */
	public function getTrackingUrlReturnsInitialValueForString()
	{
		$this->assertSame(
			'',
			$this->subject->getTrackingUrl()
		);
	}
	 ...
	 * @test
	 */
	public function setTrackingUrlForStringSetsTrackingUrl()
	{
		$this->subject->setTrackingUrl('Conceived at T3CON10');
	 ...
	 * @test
	 */
	public function getInternalCommentReturnsInitialValueForString()
	{
		$this->assertSame(
			'',
			$this->subject->getInternalComment()
		);
	}
	 ...
	 * @test
	 */
	public function setInternalCommentForStringSetsInternalComment()
	{
		$this->subject->setInternalComment('Conceived at T3CON10');
